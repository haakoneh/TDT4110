...
def main():
  ...
  # Programmet kjører i løkke helt til brukeren svarer "hade"
    ...
    # MANGLER KODE HER!!!
		spm = questions[random.randint(0,len(questions)-1)]
